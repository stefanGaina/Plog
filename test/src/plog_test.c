 ...
 * 24.01.2024  Gaina Stefan               Refactored for API-Test 2.0.1.                              *
...
static void plog_get_severity_level_test(void)
{
	...
	(void)g_fprintf(stdout,
		...
		"Verbose logs are %s\n",
		severity_level,
		IS_BIT_ENABLED_STRING(E_PLOG_SEVERITY_LEVEL_FATAL  , severity_level),
		IS_BIT_ENABLED_STRING(E_PLOG_SEVERITY_LEVEL_ERROR  , severity_level),
		IS_BIT_ENABLED_STRING(E_PLOG_SEVERITY_LEVEL_WARN   , severity_level),
		IS_BIT_ENABLED_STRING(E_PLOG_SEVERITY_LEVEL_INFO   , severity_level),
		IS_BIT_ENABLED_STRING(E_PLOG_SEVERITY_LEVEL_DEBUG  , severity_level),
		IS_BIT_ENABLED_STRING(E_PLOG_SEVERITY_LEVEL_TRACE  , severity_level),
